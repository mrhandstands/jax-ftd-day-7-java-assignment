package com.cooksys.ftd.butterpillar.model.impl;
...
public class Butterpillar implements IButterpillar {
	...
	public int compareTo(IButterpillar butterpillar) {
		if (this.length == butterpillar.getLength()) {
			if (this.leavesEaten == butterpillar.getLeavesEaten())
				return 0;
			else if (this.leavesEaten > butterpillar.getLeavesEaten())
				return 1;
			else if (this.leavesEaten < butterpillar.getLeavesEaten())
				return -1;
		}
		else if (this.length > butterpillar.getLength())
			return 1; 
		return -1;
	}
